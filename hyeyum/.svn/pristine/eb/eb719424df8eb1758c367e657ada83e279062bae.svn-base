...
import com.hyeyum.domain.AttachFileDTO;
...
//	public static final String UPLOAD_PATH = "/Users/user/upload/hyeyum/"; // 맥경로
	public static final String UPLOAD_PATH = "c:/upload/hyeyum/"; // 윈도우경로
