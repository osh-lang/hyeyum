            ...
            <div class="page-breadcrumb">
                <div class="row">
                    <div class="col-7 align-self-center">
                        <h3 class="page-title text-truncate text-dark font-weight-medium mb-1">학생조회</h3>
                            ...
                            <form method="post" action="">
								 <div class="form-row">
									 <div class="form-group col-md-3">
									    ...
									    <input type="text" class="form-control" name="studno" id="studno" readonly value="${student.studno}" placeholder="학번 입력란">
								 	 </div>
									 <div class="form-group col-md-3">
									    <label for="name">이름</label>
									    <input type="text" class="form-control" name="name" id="name" readonly value="${student.name}" placeholder="이름 입력란">
								 	 </div>
									 <div class="form-group col-md-3">
									    <label for="birthDate">생년월일</label>
									    <input type="text" class="form-control" name="birthDate" id="birthDate" readonly value="<fmt:formatDate value="${student.birthDate}" pattern="yyMMdd"/>" required pattern="[0-9]{6}" placeholder="생년월일 입력란(yymmdd)">								 	
									 </div> 
									 <div class="form-group col-md-3">
									    <label for="tel">전화번호</label>
									    <input type="text" class="form-control" name="tel" id="tel" readonly value="${student.tel}" placeholder="전화번호 입력란">								 	
									 </div>
								 </div>
                                 ...
                                 <div class="row">
							    	<div class="col-md-10">
							    		<div class="form-group">
										    <input type="text" class="form-control" name="address" id="address" readonly value="${student.address}" placeholder="주소">								 	
							    		</div>
							    	</div>
							    	<div class="col-md-2">
							    		<div class="form-group">
							    ...
							    <div class="form-row">
									 <div class="form-group col-md-3">
									    ...
									    <input type="text" class="form-control" name="deptno" id="deptno" readonly value="${student.deptno}" placeholder="학과코드">
								 	 </div>
									 <div class="form-group col-md-3">
									    <label for="profno">교수코드</label>
									    <input type="text" class="form-control" name="profno" id="profno"  readonly value="${student.profno}" placeholder="교수코드">								 	
									 </div>
									 <div class="form-group col-md-3">
									    <label for="grade">학년</label>
									    <input type="text" class="form-control" name="grade" id="grade"  value="${student.grade}" placeholder="학년">
								 	 </div>
									 <div class="form-group col-md-3">
									    <label for="status">학적상태</label>
									    <input type="text" class="form-control" name="status" id="status" placeholder="학적 상태">								 	
									 </div>
								 </div>
								 <div class="row">
								 	 <div class="col-md-4">
								 ...
								 <div class="row">
								 	<div class="col-md-12 mb-2">
								    	<button data-oper="deletestudent" class="btn btn-info btn-block" formaction="deletestudent">인적사항삭제</button>								 	
								 	</div>
								 </div>
								 <div class="row">
								 	<div class="col-md-12">
								    	<button type="submit" id="updatestudent" class="btn btn-info btn-block">인적사항수정</button>								 	
								 	</div>
								 </div>
